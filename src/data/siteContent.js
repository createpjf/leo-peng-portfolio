...
const copy = {
  en: {
    meta: {
      title: 'Leo Peng | Creative Technologist · AI Customer Success',
  ...
  zh: {
    ...
    personalInfo: {
      ...
      quoteAttribution: '- Leo Peng',
      currentStatus: '开放新的合作。',
      email: 'leo@flock.io',
      locations: '上海 · 香港 · 远程',
      footerBio: '叙事与工程相遇。立足上海，面向全球。',
    },
    expertisePills: [
      { label: 'FDE', desc: '加入客户团队，在他们的真实系统和数据上构建，跑起来才离开。' },
      { label: 'AI 客户成功', desc: '帮他们从「我们试过 AI」走到「我们每天都在用，而且真的有用」。' },
      { label: 'AI 系统', desc: 'Agent 工作流、模型路由、全栈原型与本地优先工具。' },
    ],
    navItems: [
    ...
    experience: {
      1: { date: '2023 - 至今', role: 'Forward Deployed Engineer (FDE)', company: 'FLock.io - 隐私保护 AI', type: '全职' },
