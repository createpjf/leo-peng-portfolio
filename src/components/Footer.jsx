...
// Bootstrap Icons v1.13.1 (MIT); attribution in assets/Bootstrap-Icons-LICENSE.txt.
const socialIconPaths = {
  'Twitter / X': 'M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z',
      ...
      <div className="footer-grid" style={{
        ...
        <div className="footer-col">
          ...
          {socialLinks.map(item => (
            ...
            >{socialIconPaths[item.label] && <svg className="footer-icon" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" focusable="false"><path d={socialIconPaths[item.label]} /></svg>}{item.label}</a>
          ))}
        </div>
        ...
        <div className="footer-col">
          ...
          <a href={`mailto:${personalInfo.email}`}
            className="footer-link"
            style={{ fontSize: F.base }}
          ><svg className="footer-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true" focusable="false"><rect x="3" y="5" width="18" height="14" rx="2" /><path d="m3 6 9 7 9-7" /></svg>{personalInfo.email}</a>
        </div>
      </div>
